...
function Player:init(i, j, playerNumber)
    ...
    self:addState("dead", 64 + playerShift, 67 + playerShift, {
        tickStep = speed,
        loop = false
    })

    self:addState('p1IdleUp', 1 + playerShift, 1 + playerShift, {
        tickStep = speed
    })
    ...
    self:addState('p1IdleRight', 10 + playerShift, 10 + playerShift, {
        tickStep = speed
    })
    ...
    self:addState('p1IdleDown', 19 + playerShift, 19 + playerShift, {
        tickStep = speed
    }).asDefault()
    ...
    self:addState('p1IdleLeft', 28 + playerShift, 28 + playerShift, {
        tickStep = speed
    })
    ...
    self:setCollidesWithGroups({collisionGroup.block, collisionGroup.bomb, collisionGroup.bomb, collisionGroup.item,
                                collisionGroup.p1, collisionGroup.p2, collisionGroup.explosion})
